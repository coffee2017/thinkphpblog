...
class Tree {
	...
	*/
	 ...
	 */
    function get_treeview($myid,$effected_id='example',$str="<span class='file'>\$naviname</span>", $str2="" ,$showlevel = 0 ,$style='filetree ' , $currentlevel = 1,$recursion=FALSE) {
        $child = $this->get_child($myid);
        ...
        if(!$recursion) $this->str .='<ul'.$effected.'  class="'.$style.'"><li><a href="/"><span>首页</span><span class="en">Home</span></a></li>';
        foreach($child as $id=>$a) {
//<a href="index.html"><span>首页</span><span class="en">Home</span></a>
            ...
            $this->str .= $recursion ? '<ul><li'.$floder_status.' id=\''.$id.'\'>'.'<a href="/cate/'.$id.'.html"><span>'.$a['naviname'].'</span><span class="en">'.$a['en_name'].'</span></a>': '<li'.$floder_status.' id=\''.$id.'\'>'.'<a href="/cate/'.$id.'.html"><span>'.$a['naviname'].'</span><span class="en">'.$a['en_name'].'</span></a>';
            $recursion = FALSE;
