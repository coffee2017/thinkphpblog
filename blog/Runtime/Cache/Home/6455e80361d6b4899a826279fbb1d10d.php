  ...
  <div class="container">
    ...
    <div class="about left">
      ...
      <ul>
        ...
        <p class="newsnav">您现在的位置是:<a href="/">首页</a>&nbsp;>&nbsp;<a href="<?php echo U('/cate/'.$blog['navid']);?>"><?php echo ($blog["naviname"]); ?></a></p>
      ...
      <div class="nextinfo">
        <?php if($front != null): ?><p>上一篇：<a href="<?php echo U('/article/'.$front['gid']);?>"><?php echo ($front['title']); ?></a></p><?php endif; ?>
        <?php if($after != null): ?><p>下一篇：<a href="<?php echo U('/article/'.$after['gid']);?>"><?php echo ($after['title']); ?></a></p><?php endif; ?>
      </div>
      <div class="otherlink">
        <h2>相关文章</h2>
        <ul>
          <?php if(is_array($other)): foreach($other as $key=>$v): ?><li><a href="<?php echo U('/article/'.$v['gid']);?>"><?php echo ($v['title']); ?></a></li><?php endforeach; endif; ?>
        </ul>
      </div>
      <div class="gbko">
