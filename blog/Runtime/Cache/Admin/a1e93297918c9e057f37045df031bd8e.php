  ...
  <div id="page-wrapper">
    <div id="page-inner">
      ...
      <div class="row">
        ...
        <form class="form-horizontal" id="form" method="post" action="<?php echo U('groupadd');?>">
        <div class="modal-body">
          <div class="space-4"></div>
          <div class="form-group">
            <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 用户组 </label>
            <div class="col-sm-9">
              <input type="text" name="groupname" id="title" class="rcol-xs-10 col-sm-5" value="<?php echo ($vv["naviname"]); ?>">
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <?php if(is_array($navs)): foreach($navs as $key=>$v): ?><tr>
                  <td class="center">
                    <input class="items" type="checkbox" name="menu[]" value="<?php echo ($v["id"]); ?>">
                  </td>
                ...
                <?php if(is_array($navp)): foreach($navp as $key=>$vp): if($v["id"] == $vp['pid']): ?><tr>
                      <td class="center">
                        <input class="items" type="checkbox" name="menu[]" value="<?php echo ($vp["id"]); ?>">
                      </td>
                    ...
                    <?php if(is_array($navp)): foreach($navp as $key=>$vpp): if($vp["id"] == $vpp['pid']): ?><tr>
                          <td class="center">
                            <input class="items" type="checkbox" name="menu[]" value="<?php echo ($vpp["id"]); ?>">
                          </td>
