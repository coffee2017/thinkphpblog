...
<nav class="navbar-default navbar-side" role="navigation">
  <div class="sidebar-collapse">
    <ul class="nav" id="main-menu">
      ...
      <li>
        <a <?php if($active == ('Index/Index')): ?>class='active-menu'<?php endif; ?> href="<?php echo U('Index/Index');?>"><i class="fa fa-dashboard "></i>控制台</a>
      </li>
      </li>
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
                ...
                <form class="form-horizontal" id="form" method="post" action="<?php echo U("checkboxdel");?>">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                        <?php if(is_array($var)): foreach($var as $key=>$v): ?><tr>
                                <td><input type="checkbox" class="items" name="<?php echo ($v["id"]); ?>" value='<?php echo ($v["k"]); ?>' /></td>
                                ...
                                <td><?php echo ($v["v"]); ?></td>
                                <td>
                                    <a href="<?php echo U('Variable/edit',array('k'=>$v['k']));?>">
                                    <i class="ace-icon fa fa-pencil bigger-100"></i>
                                    修改
                                    </a>&nbsp&nbsp;
                                    <a href="javascript:;" val="<?php echo U('Variable/del',array('k'=>$v['k']));?>" class="dellink">
