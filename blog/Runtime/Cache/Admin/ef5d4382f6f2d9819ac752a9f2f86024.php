...
<nav class="navbar-default navbar-side" role="navigation">
  ...
  <div id="page-wrapper">
    <div id="page-inner">
      <div class="row">
        <div class="col-md-12">
          <h1 class="page-head-line">新增用户</h1>
        </div>
      </div>
      <!-- /. ROW  -->
      <div class="row">
        ...
        <form class="form-horizontal" id="form" method="post" action="<?php echo U('Add');?>">
          <div class="modal-body">
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="username" id="name" placeholder="用户名" class="col-xs-10 col-sm-5" value="">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <select name="roleid" class="col-xs-10 col-sm-5">
                  <?php if(is_array($role)): foreach($role as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["groupname"]); ?></option><?php endforeach; endif; ?>
                </select>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="email" id="email" placeholder="邮箱" class="col-xs-10 col-sm-5" value="">
              </div>
            </div>
