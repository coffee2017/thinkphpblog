        ...
        <div class="col-xs-12">
          ...
          <div class="cf">
            <form class="form-inline" action="" method="get">
              <a class="btn btn-info" href="<?php echo U('Blog/add');?>" value="">新增</a>
              ...
              <select name="order" class="form-control">
                ...
                <option value="asc" <?php if($_GET['order'] == asc): ?>selected<?php endif; ?>>发布时间升序</option>
              </select>
        ...
        <form id="form" method="post" action="">
          <table class="table table-striped table-bordered">
            ...
            <?php if(is_array($blog)): foreach($blog as $key=>$v): ?><tr>
                <td class="center">
                  <input class="items" type="checkbox" name="gid" value="<?php echo ($v["gid"]); ?>">
                </td>
                <td>
                  <a href="<?php echo U('Blog/index',array('navid'=>$v['id']));?>" title="<?php echo ($v["naviname"]); ?>"><?php echo ($v["naviname"]); ?></a>
                </td>
                <td><?php echo ($v["title"]); ?></td>
                <td><?php echo ($v["date"]); ?></td>
                <td><?php echo ($v["edit_date"]); ?></td>
                <td>
                  <a href="<?php echo U('Blog/edit',array('gid'=>$v['gid']));?>">
                    <i class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;
                  <a href="javascript:;" val="<?php echo ($v["gid"]); ?>" class="dellink">
