      ...
      <div class="row">
        ...
        <table class="table table-striped table-bordered">
          ...
          <?php if(is_array($role)): foreach($role as $key=>$v): ?><tr>
              <?php if(($v['id'] == 1) ): ?><td>--</td>
                <?php else: ?>
                <td><input type="checkbox" class="items" name="<?php echo ($v["id"]); ?>" value='<?php echo ($v["id"]); ?>'/></td><?php endif; ?>

              <td><?php echo ($v["groupname"]); ?></td>
              <td>


                  <?php if(in_array(61,$uid) || session(roleid) == 1): ?><a href="<?php echo U('User/groupedit',array('id'=>$v['id']));?>">
                      <i class="ace-icon fa fa-pencil bigger-100"></i>
                      修改
                    </a>&nbsp&nbsp;
                    <?php if(($v['id'] != 1) ): ?><a href="javascript:;" val="<?php echo U('User/groupdel',array('id'=>$v['id']));?>" class="dellink">
