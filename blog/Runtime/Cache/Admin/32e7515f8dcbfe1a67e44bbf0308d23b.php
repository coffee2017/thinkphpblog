          ...
          <div class="cf">
            <form class="form-inline" action="" method="get">
              ...
              <select name="order" class="form-control">
                <option value="desc">发布时间降序</option>
                <option value="asc">发布时间升序</option>
              </select>
        ...
        <form id="form" method="post" action="<?php echo U('checkdel');?>">
          <table class="table table-striped table-bordered">
            ...
            <?php if(is_array($blog)): foreach($blog as $key=>$v): ?><tr>
                <td class="center">
                  <input class="aids" type="checkbox" name="id[]" value="1">
                </td>
                <td>
    ...
    $(".dellink").click(function () {
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                ...
                if (result) {
                    $.get("/blog/index.php/Admin/Blog/index/?id=" + id, function (result) {
                        if (result == 2) {
                            bootbox.alert({
                                buttons: {
                                    ok: {
